          ...
          <div className="flex-1 overflow-y-auto px-6 py-5 space-y-5">
            ...
            <div className="space-y-2">
              ...
              <ul className="space-y-1.5 text-xs text-muted ml-5 list-disc">
                ...
                <li>Planes, OKRs, métricas de equipos, vulnerabilidades y hallazgos de auditoría pueden revelar estrategia institucional o brechas de seguridad.</li>
              </ul>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                {[
                  { icon: Lock, text: 'Cifrado opcional AES-GCM 256 con passphrase', color: 'text-success' },
                  { icon: Clock, text: 'Caducidad automática a las 48 horas', color: 'text-warning' },
                  { icon: Database, text: 'Limpieza programada de archivos en Azure', color: 'text-info' },
                  { icon: Eye, text: 'Vistas públicas de solo lectura', color: 'text-info' },
                  { icon: Shield, text: 'Autenticación requerida para generar enlaces', color: 'text-success' },
            ...
            <div className="space-y-2">
              ...
              <ul className="space-y-1.5 text-xs text-muted ml-5 list-disc">
                ...
                <li>Notifica al equipo de seguridad si se comparten datos clasificados por error.</li>
              </ul>
            </div>
