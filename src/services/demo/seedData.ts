...
export async function seedDemoData(force = false) {
  ...
  const plan1Activities: Activity[] = [
    { id: 'act-1', planId: 'plan-1', parentActivityId: null, title: 'Migrar Core Banking a .NET 8', description: 'Actualizar el framework del core bancario de .NET 6 a .NET 8', assigneeId: 'user-1', teamId: 'team-1', applicationId: 'app-1', priority: 'critical', status: 'in_progress', estimatedHours: 80, actualHours: 45, plannedPoints: 21, completedPoints: 8, sortOrder: 1, startDate: ds(-40), dueDate: ds(20), completedAt: null, metadata: {}, createdAt: ds(-40), updatedAt: ds(-1) },
    { id: 'act-2', planId: 'plan-1', parentActivityId: 'act-1', title: 'Actualizar dependencias NuGet', description: 'Actualizar paquetes a versiones compatibles con .NET 8', assigneeId: 'user-1', teamId: 'team-1', applicationId: 'app-1', priority: 'high', status: 'completed', estimatedHours: 16, actualHours: 14, plannedPoints: 5, completedPoints: 5, sortOrder: 1, startDate: ds(-40), dueDate: ds(-15), completedAt: ds(-16), metadata: {}, createdAt: ds(-40), updatedAt: ds(-16) },
    { id: 'act-3', planId: 'plan-1', parentActivityId: 'act-1', title: 'Migrar controladores MVC', description: 'Migrar todos los controladores a la nueva versión de ASP.NET Core', assigneeId: 'user-1', teamId: 'team-1', applicationId: 'app-1', priority: 'high', status: 'in_progress', estimatedHours: 32, actualHours: 20, plannedPoints: 8, completedPoints: 4, sortOrder: 2, startDate: ds(-30), dueDate: ds(10), completedAt: null, metadata: {}, createdAt: ds(-30), updatedAt: ds(-1) },
    { id: 'act-18', planId: 'plan-1', parentActivityId: 'act-1', title: 'Migrar capa de datos a EF Core', description: 'Migrar la capa de acceso a datos de ADO.NET a Entity Framework Core', assigneeId: null, teamId: 'team-1', applicationId: 'app-1', priority: 'medium', status: 'pending', estimatedHours: 24, actualHours: null, plannedPoints: 8, completedPoints: null, sortOrder: 3, startDate: ds(2), dueDate: ds(20), completedAt: null, metadata: {}, createdAt: ds(-5), updatedAt: ds(-5) },
    { id: 'act-4', planId: 'plan-1', parentActivityId: null, title: 'Actualizar PostgreSQL 16', description: 'Migración de base de datos de PostgreSQL 14 a 16', assigneeId: 'user-2', teamId: 'team-1', applicationId: 'app-1', priority: 'medium', status: 'in_progress', estimatedHours: 40, actualHours: 25, plannedPoints: 13, completedPoints: 6, sortOrder: 2, startDate: ds(-35), dueDate: ds(5), completedAt: null, metadata: {}, createdAt: ds(-35), updatedAt: ds(-1) },
    { id: 'act-5', planId: 'plan-1', parentActivityId: null, title: 'Implementar OAuth2 en Portal', description: 'Migrar autenticación a OAuth2 con Keycloak — BLOQUEADO por certificado SSL vencido', assigneeId: 'user-1', teamId: 'team-1', applicationId: 'app-2', priority: 'high', status: 'pending', estimatedHours: 24, actualHours: null, plannedPoints: 8, completedPoints: null, sortOrder: 3, startDate: ds(1), dueDate: ds(0), completedAt: null, metadata: {}, createdAt: ds(-10), updatedAt: ds(-1) },
    { id: 'act-19', planId: 'plan-1', parentActivityId: null, title: 'Actualizar librerías de logging', description: 'Actualizar Serilog y NLog a versiones compatibles con .NET 8', assigneeId: 'user-3', teamId: 'team-1', applicationId: 'app-1', priority: 'low', status: 'completed', estimatedHours: 8, actualHours: 6, plannedPoints: 3, completedPoints: 3, sortOrder: 4, startDate: ds(-45), dueDate: ds(-30), completedAt: ds(-31), metadata: {}, createdAt: ds(-45), updatedAt: ds(-31) },
    { id: 'act-20', planId: 'plan-1', parentActivityId: null, title: 'Pruebas de integración del core', description: 'Suite completa de pruebas de integración post-migración', assigneeId: null, teamId: 'team-1', applicationId: 'app-1', priority: 'high', status: 'pending', estimatedHours: 40, actualHours: null, plannedPoints: 13, completedPoints: null, sortOrder: 5, startDate: ds(15), dueDate: ds(45), completedAt: null, metadata: {}, createdAt: ds(-1), updatedAt: ds(-1) },
  ]

  // ── Plan 2: Seguridad (en progreso, green) ──
  const plan2Activities: Activity[] = [
    { id: 'act-6', planId: 'plan-2', parentActivityId: null, title: 'Auditoría de vulnerabilidades', description: 'Escaneo completo de vulnerabilidades en todas las apps del portafolio', assigneeId: 'user-2', teamId: 'team-2', applicationId: 'app-2', priority: 'critical', status: 'completed', estimatedHours: 16, actualHours: 18, plannedPoints: 13, completedPoints: 13, sortOrder: 1, startDate: ds(-20), dueDate: ds(-5), completedAt: ds(-6), metadata: {}, createdAt: ds(-20), updatedAt: ds(-6) },
    { id: 'act-7', planId: 'plan-2', parentActivityId: null, title: 'Corregir XSS en formularios de búsqueda', description: 'Sanitizar inputs en el portal clientes — VENCE HOY', assigneeId: 'user-2', teamId: 'team-2', applicationId: 'app-2', priority: 'high', status: 'in_progress', estimatedHours: 12, actualHours: 6, plannedPoints: 5, completedPoints: 2, sortOrder: 2, startDate: ds(-14), dueDate: ds(0), completedAt: null, metadata: {}, createdAt: ds(-14), updatedAt: ds(-1) },
    { id: 'act-8', planId: 'plan-2', parentActivityId: null, title: 'Implementar CSP headers', description: 'Agregar Content Security Policy headers a todas las respuestas HTTP', assigneeId: null, teamId: 'team-2', applicationId: 'app-2', priority: 'medium', status: 'pending', estimatedHours: 8, actualHours: null, plannedPoints: 3, completedPoints: null, sortOrder: 3, startDate: ds(2), dueDate: ds(10), completedAt: null, metadata: {}, createdAt: ds(-7), updatedAt: ds(-1) },
    { id: 'act-21', planId: 'plan-2', parentActivityId: null, title: 'Implementar WAF en API Gateway', description: 'Configurar Web Application Firewall en el API Gateway del portal', assigneeId: 'user-2', teamId: 'team-2', applicationId: 'app-2', priority: 'high', status: 'in_progress', estimatedHours: 20, actualHours: 8, plannedPoints: 8, completedPoints: 3, sortOrder: 4, startDate: ds(-10), dueDate: ds(15), completedAt: null, metadata: {}, createdAt: ds(-10), updatedAt: ds(-1) },
    { id: 'act-22', planId: 'plan-2', parentActivityId: null, title: 'Parchear servidores Ubuntu 20.04', description: 'Aplicar parches de seguridad críticos a servidores Ubuntu con CVE-2024-6387', assigneeId: 'user-5', teamId: 'team-2', applicationId: 'app-9', priority: 'critical', status: 'in_progress', estimatedHours: 16, actualHours: 4, plannedPoints: 5, completedPoints: 1, sortOrder: 5, startDate: ds(-25), dueDate: ds(-3), completedAt: null, metadata: {}, createdAt: ds(-25), updatedAt: ds(-3) },
  ]

  // ── Plan 3: Migración CRM (planned, green) ──
  const plan3Activities: Activity[] = [
    { id: 'act-9', planId: 'plan-3', parentActivityId: null, title: 'Análisis de impacto y dependencias del CRM', description: 'Evaluar el impacto de migrar el CRM legacy al nuevo sistema', assigneeId: 'user-4', teamId: 'team-2', applicationId: 'app-5', priority: 'high', status: 'pending', estimatedHours: 24, actualHours: null, plannedPoints: 8, completedPoints: null, sortOrder: 1, startDate: ds(15), dueDate: ds(30), completedAt: null, metadata: {}, createdAt: ds(-10), updatedAt: ds(-10) },
    { id: 'act-10', planId: 'plan-3', parentActivityId: null, title: 'Migración de datos a nuevo CRM', description: 'Migrar datos históricos del CRM legacy al nuevo sistema', assigneeId: null, teamId: 'team-2', applicationId: 'app-5', priority: 'critical', status: 'pending', estimatedHours: 80, actualHours: null, plannedPoints: 21, completedPoints: null, sortOrder: 2, startDate: ds(30), dueDate: ds(60), completedAt: null, metadata: {}, createdAt: ds(-10), updatedAt: ds(-10) },
    { id: 'act-11', planId: 'plan-3', parentActivityId: null, title: 'Capacitación usuarios nuevo CRM', description: 'Entrenar a los usuarios finales en el nuevo sistema CRM', assigneeId: null, teamId: 'team-2', applicationId: 'app-5', priority: 'medium', status: 'pending', estimatedHours: 16, actualHours: null, plannedPoints: 5, completedPoints: null, sortOrder: 3, startDate: ds(60), dueDate: ds(75), completedAt: null, metadata: {}, createdAt: ds(-10), updatedAt: ds(-10) },
  ]

  // ── Plan 4: App Móvil (en progreso, red — en crisis) ──
  const plan4Activities: Activity[] = [
    { id: 'act-12', planId: 'plan-4', parentActivityId: null, title: 'Implementar modo offline', description: 'Soporte offline completo para la app móvil con sincronización', assigneeId: 'user-3', teamId: 'team-1', applicationId: 'app-3', priority: 'critical', status: 'in_progress', estimatedHours: 60, actualHours: 20, plannedPoints: 21, completedPoints: 5, sortOrder: 1, startDate: ds(-15), dueDate: ds(30), completedAt: null, metadata: {}, createdAt: ds(-20), updatedAt: ds(-1) },
    { id: 'act-23', planId: 'plan-4', parentActivityId: 'act-12', title: 'Diseñar esquema de caché local', description: 'Diseñar esquema de almacenamiento offline con IndexedDB', assigneeId: 'user-3', teamId: 'team-1', applicationId: 'app-3', priority: 'high', status: 'in_progress', estimatedHours: 12, actualHours: 10, plannedPoints: 5, completedPoints: 3, sortOrder: 1, startDate: ds(-15), dueDate: ds(-5), completedAt: null, metadata: {}, createdAt: ds(-20), updatedAt: ds(-5) },
    { id: 'act-24', planId: 'plan-4', parentActivityId: 'act-12', title: 'Implementar sincronización en segundo plano', description: 'Sincronización automática al recuperar conectividad', assigneeId: 'user-3', teamId: 'team-1', applicationId: 'app-3', priority: 'high', status: 'in_progress', estimatedHours: 24, actualHours: 8, plannedPoints: 8, completedPoints: 2, sortOrder: 2, startDate: ds(-8), dueDate: ds(10), completedAt: null, metadata: {}, createdAt: ds(-10), updatedAt: ds(-1) },
    { id: 'act-25', planId: 'plan-4', parentActivityId: 'act-12', title: 'Pruebas de sincronización offline', description: 'Suite de pruebas para el modo offline en múltiples escenarios de red', assigneeId: null, teamId: 'team-1', applicationId: 'app-3', priority: 'medium', status: 'pending', estimatedHours: 16, actualHours: null, plannedPoints: 5, completedPoints: null, sortOrder: 3, startDate: ds(10), dueDate: ds(30), completedAt: null, metadata: {}, createdAt: ds(-5), updatedAt: ds(-5) },
    { id: 'act-13', planId: 'plan-4', parentActivityId: null, title: 'Rediseño de navegación principal', description: 'Nuevo diseño de navegación con bottom tabs y gestos', assigneeId: 'user-3', teamId: 'team-1', applicationId: 'app-3', priority: 'high', status: 'in_progress', estimatedHours: 32, actualHours: 12, plannedPoints: 8, completedPoints: 3, sortOrder: 2, startDate: ds(-10), dueDate: ds(-2), completedAt: null, metadata: {}, createdAt: ds(-15), updatedAt: ds(-2) },
    { id: 'act-14', planId: 'plan-4', parentActivityId: null, title: 'Integración notificaciones push', description: 'Integrar Firebase Cloud Messaging para notificaciones push', assigneeId: null, teamId: 'team-1', applicationId: 'app-3', priority: 'medium', status: 'pending', estimatedHours: 16, actualHours: null, plannedPoints: 5, completedPoints: null, sortOrder: 3, startDate: ds(10), dueDate: ds(45), completedAt: null, metadata: {}, createdAt: ds(-10), updatedAt: ds(-1) },
  ]

  // ── Plan 5: Infraestructura (completado, green) ──
  const plan5Activities: Activity[] = [
    { id: 'act-15', planId: 'plan-5', parentActivityId: null, title: 'Migrar servidores a Ubuntu 24.04', description: 'Migración completa de servidores de Ubuntu 20.04 a 24.04 LTS', assigneeId: 'user-5', teamId: 'team-2', applicationId: 'app-9', priority: 'critical', status: 'completed', estimatedHours: 40, actualHours: 38, plannedPoints: 13, completedPoints: 13, sortOrder: 1, startDate: ds(-90), dueDate: ds(-60), completedAt: ds(-61), metadata: {}, createdAt: ds(-90), updatedAt: ds(-61) },
    { id: 'act-16', planId: 'plan-5', parentActivityId: null, title: 'Actualizar Kubernetes a 1.29', description: 'Upgrade del cluster Kubernetes de 1.27 a 1.29', assigneeId: 'user-2', teamId: 'team-2', applicationId: 'app-9', priority: 'high', status: 'completed', estimatedHours: 24, actualHours: 28, plannedPoints: 8, completedPoints: 8, sortOrder: 2, startDate: ds(-80), dueDate: ds(-50), completedAt: ds(-51), metadata: {}, createdAt: ds(-80), updatedAt: ds(-51) },
    { id: 'act-17', planId: 'plan-5', parentActivityId: null, title: 'Implementar monitoring con Prometheus', description: 'Desplegar stack Prometheus + Grafana para monitoreo de infraestructura', assigneeId: 'user-5', teamId: 'team-2', applicationId: 'app-9', priority: 'medium', status: 'completed', estimatedHours: 32, actualHours: 30, plannedPoints: 8, completedPoints: 8, sortOrder: 3, startDate: ds(-60), dueDate: ds(-30), completedAt: ds(-31), metadata: {}, createdAt: ds(-60), updatedAt: ds(-31) },
  ]

  // ── Nested activities (nivel 3+) ──
  const deepActivities: Activity[] = [
    // Plan 1: Nivel 3 bajo act-3 (Migrar controladores MVC → hijo de act-1)
    { id: 'act-26', planId: 'plan-1', parentActivityId: 'act-3', title: 'Migrar controlador de autenticación', description: 'Migrar login, registro y recuperación de contraseña a ASP.NET Core 8', assigneeId: 'user-1', teamId: 'team-1', applicationId: 'app-1', priority: 'high', status: 'in_progress', estimatedHours: 12, actualHours: 6, plannedPoints: 3, completedPoints: 1, sortOrder: 1, startDate: ds(-25), dueDate: ds(-5), completedAt: null, metadata: {}, createdAt: ds(-30), updatedAt: ds(-5) },
    { id: 'act-27', planId: 'plan-1', parentActivityId: 'act-3', title: 'Migrar controlador de transacciones', description: 'Migrar depósitos, retiros y transferencias a ASP.NET Core 8', assigneeId: 'user-1', teamId: 'team-1', applicationId: 'app-1', priority: 'critical', status: 'pending', estimatedHours: 16, actualHours: null, plannedPoints: 5, completedPoints: null, sortOrder: 2, startDate: ds(-5), dueDate: ds(10), completedAt: null, metadata: {}, createdAt: ds(-25), updatedAt: ds(-5) },
    { id: 'act-28', planId: 'plan-1', parentActivityId: 'act-3', title: 'Migrar controlador de reportes', description: 'Migrar generación de extractos y reportes financieros a ASP.NET Core 8', assigneeId: null, teamId: 'team-1', applicationId: 'app-1', priority: 'medium', status: 'pending', estimatedHours: 8, actualHours: null, plannedPoints: 2, completedPoints: null, sortOrder: 3, startDate: ds(10), dueDate: ds(25), completedAt: null, metadata: {}, createdAt: ds(-20), updatedAt: ds(-5) },

    // Plan 4: Nivel 3 bajo act-24 (Implementar sincronización → hijo de act-12)
    { id: 'act-29', planId: 'plan-4', parentActivityId: 'act-24', title: 'Diseñar cola de operaciones pendientes', description: 'Diseñar cola FIFO con reintentos para operaciones offline', assigneeId: 'user-3', teamId: 'team-1', applicationId: 'app-3', priority: 'high', status: 'in_progress', estimatedHours: 8, actualHours: 4, plannedPoints: 3, completedPoints: 1, sortOrder: 1, startDate: ds(-6), dueDate: ds(-1), completedAt: null, metadata: {}, createdAt: ds(-8), updatedAt: ds(-2) },
    { id: 'act-30', planId: 'plan-4', parentActivityId: 'act-24', title: 'Implementar resolución de conflictos', description: 'Estrategia last-write-wins con merge de cambios locales y remotos', assigneeId: 'user-3', teamId: 'team-1', applicationId: 'app-3', priority: 'high', status: 'pending', estimatedHours: 12, actualHours: null, plannedPoints: 5, completedPoints: null, sortOrder: 2, startDate: ds(0), dueDate: ds(8), completedAt: null, metadata: {}, createdAt: ds(-6), updatedAt: ds(-2) },

    // Plan 4: Nivel 3 bajo act-13 (Rediseño de navegación principal)
    { id: 'act-31', planId: 'plan-4', parentActivityId: 'act-13', title: 'Implementar animaciones de transición', description: 'Agregar animaciones fluidas entre pantallas con gesture handlers', assigneeId: 'user-3', teamId: 'team-1', applicationId: 'app-3', priority: 'medium', status: 'in_progress', estimatedHours: 12, actualHours: 6, plannedPoints: 3, completedPoints: 1, sortOrder: 1, startDate: ds(-8), dueDate: ds(0), completedAt: null, metadata: {}, createdAt: ds(-12), updatedAt: ds(-2) },
    { id: 'act-32', planId: 'plan-4', parentActivityId: 'act-13', title: 'Pruebas de navegación en múltiples dispositivos', description: 'Validar navegación y gestos en iOS y Android con distintos tamaños de pantalla', assigneeId: null, teamId: 'team-1', applicationId: 'app-3', priority: 'medium', status: 'pending', estimatedHours: 8, actualHours: null, plannedPoints: 2, completedPoints: null, sortOrder: 2, startDate: ds(1), dueDate: ds(10), completedAt: null, metadata: {}, createdAt: ds(-10), updatedAt: ds(-2) },
  ]
  ...
  // ── Tasks ──
  const tasks: Task[] = [
    { id: 'task-1', activityId: 'act-1', planId: 'plan-1', title: 'Evaluar cambios de versión .NET 8', description: 'Revisar breaking changes y planificar migración', assigneeId: 'user-1', status: 'done', priority: 'medium', estimatedHours: 4, dueDate: ds(-38), completedAt: ds(-39), dependsOn: [], sortOrder: 1, metadata: {}, createdAt: ds(-40), updatedAt: ds(-39) },
    { id: 'task-2', activityId: 'act-1', planId: 'plan-1', title: 'Actualizar Dockerfile a .NET 8 SDK', description: 'Cambiar imagen base en Dockerfile', assigneeId: 'user-1', status: 'done', priority: 'high', estimatedHours: 2, dueDate: ds(-35), completedAt: ds(-36), dependsOn: ['task-1'], sortOrder: 2, metadata: {}, createdAt: ds(-40), updatedAt: ds(-36) },
    { id: 'task-3', activityId: 'act-1', planId: 'plan-1', title: 'Verificar compatibilidad de paquetes NuGet', description: 'Validar que todos los paquetes tengan versión para .NET 8', assigneeId: 'user-1', status: 'in_progress', priority: 'high', estimatedHours: 8, dueDate: ds(-1), completedAt: null, dependsOn: ['task-2'], sortOrder: 3, metadata: {}, createdAt: ds(-30), updatedAt: ds(-2) },
    { id: 'task-4', activityId: 'act-4', planId: 'plan-1', title: 'Hacer dump de BD actual', description: 'Respaldar base de datos PostgreSQL 14 antes de migrar', assigneeId: 'user-2', status: 'done', priority: 'critical', estimatedHours: 2, dueDate: ds(-30), completedAt: ds(-31), dependsOn: [], sortOrder: 1, metadata: {}, createdAt: ds(-35), updatedAt: ds(-31) },
    { id: 'task-5', activityId: 'act-4', planId: 'plan-1', title: 'Ejecutar pg_upgrade en staging', description: 'Probar la migración en entorno de staging primero', assigneeId: 'user-2', status: 'done', priority: 'critical', estimatedHours: 4, dueDate: ds(-10), completedAt: ds(-11), dependsOn: ['task-4'], sortOrder: 2, metadata: {}, createdAt: ds(-10), updatedAt: ds(-11) },
    { id: 'task-5b', activityId: 'act-4', planId: 'plan-1', title: 'Ejecutar pg_upgrade en producción', description: 'Migrar base de datos de producción a PostgreSQL 16', assigneeId: 'user-2', status: 'todo', priority: 'critical', estimatedHours: 4, dueDate: ds(2), completedAt: null, dependsOn: ['task-5'], sortOrder: 3, metadata: {}, createdAt: ds(-10), updatedAt: ds(-2) },
    { id: 'task-5c', activityId: 'act-4', planId: 'plan-1', title: 'Verificar integridad post-migración', description: 'Ejecutar scripts de validación de datos tras la migración', assigneeId: 'user-2', status: 'todo', priority: 'high', estimatedHours: 2, dueDate: ds(3), completedAt: null, dependsOn: ['task-5b'], sortOrder: 4, metadata: {}, createdAt: ds(-5), updatedAt: ds(-5) },

    { id: 'task-6', activityId: 'act-7', planId: 'plan-2', title: 'Identificar endpoints vulnerables', description: 'Mapear endpoints del portal que aceptan input de usuario', assigneeId: 'user-2', status: 'done', priority: 'high', estimatedHours: 3, dueDate: ds(-10), completedAt: ds(-11), dependsOn: [], sortOrder: 1, metadata: {}, createdAt: ds(-14), updatedAt: ds(-11) },
    { id: 'task-7', activityId: 'act-7', planId: 'plan-2', title: 'Implementar sanitización en backend XSS', description: 'Sanitizar inputs en todos los endpoints de búsqueda — VENCE HOY', assigneeId: 'user-2', status: 'in_progress', priority: 'high', estimatedHours: 6, dueDate: ds(0), completedAt: null, dependsOn: ['task-6'], sortOrder: 2, metadata: {}, createdAt: ds(-10), updatedAt: ds(0) },
    { id: 'task-7b', activityId: 'act-7', planId: 'plan-2', title: 'Validar formulario de login', description: 'Verificar que el formulario de login sanitiza correctamente', assigneeId: 'user-2', status: 'done', priority: 'medium', estimatedHours: 2, dueDate: ds(0), completedAt: ds(-1), dependsOn: [], sortOrder: 3, metadata: {}, createdAt: ds(-3), updatedAt: ds(-1) },
    { id: 'task-8', activityId: 'act-7', planId: 'plan-2', title: 'Agregar tests de seguridad XSS', description: 'Escribir tests automatizados para validar sanitización', assigneeId: 'user-2', status: 'todo', priority: 'medium', estimatedHours: 4, dueDate: ds(2), completedAt: null, dependsOn: ['task-7'], sortOrder: 4, metadata: {}, createdAt: ds(-7), updatedAt: ds(-2) },
    { id: 'task-22a', activityId: 'act-22', planId: 'plan-2', title: 'Evaluar parches disponibles', description: 'Revisar parches de seguridad para CVE-2024-6387', assigneeId: 'user-5', status: 'done', priority: 'critical', estimatedHours: 2, dueDate: ds(-20), completedAt: ds(-21), dependsOn: [], sortOrder: 1, metadata: {}, createdAt: ds(-25), updatedAt: ds(-21) },
    { id: 'task-22b', activityId: 'act-22', planId: 'plan-2', title: 'Aplicar parches en servidores staging', description: 'Probar parches en entorno de staging', assigneeId: 'user-5', status: 'in_progress', priority: 'critical', estimatedHours: 8, dueDate: ds(-5), completedAt: null, dependsOn: ['task-22a'], sortOrder: 2, metadata: {}, createdAt: ds(-20), updatedAt: ds(-5) },
    { id: 'task-22c', activityId: 'act-22', planId: 'plan-2', title: 'Aplicar parches en producción', description: 'Desplegar parches en servidores productivos', assigneeId: 'user-5', status: 'todo', priority: 'critical', estimatedHours: 6, dueDate: ds(2), completedAt: null, dependsOn: ['task-22b'], sortOrder: 3, metadata: {}, createdAt: ds(-15), updatedAt: ds(-5) },

    { id: 'task-12a', activityId: 'act-23', planId: 'plan-4', title: 'Definir schema IndexedDB para caché', description: 'Diseñar las tablas de almacenamiento offline', assigneeId: 'user-3', status: 'done', priority: 'high', estimatedHours: 4, dueDate: ds(-12), completedAt: ds(-13), dependsOn: [], sortOrder: 1, metadata: {}, createdAt: ds(-15), updatedAt: ds(-13) },
    { id: 'task-12b', activityId: 'act-23', planId: 'plan-4', title: 'Implementar service worker', description: 'Crear service worker para caché de assets y API — VENCE HOY', assigneeId: 'user-3', status: 'todo', priority: 'high', estimatedHours: 8, dueDate: ds(0), completedAt: null, dependsOn: ['task-12a'], sortOrder: 2, metadata: {}, createdAt: ds(-10), updatedAt: ds(-1) },
    { id: 'task-12c', activityId: 'act-24', planId: 'plan-4', title: 'Implementar cola de sincronización', description: 'Crear cola de operaciones pendientes para sincronizar al reconectar', assigneeId: 'user-3', status: 'todo', priority: 'high', estimatedHours: 12, dueDate: ds(8), completedAt: null, dependsOn: ['task-12b'], sortOrder: 1, metadata: {}, createdAt: ds(-8), updatedAt: ds(-2) },
    { id: 'task-13a', activityId: 'act-13', planId: 'plan-4', title: 'Diseñar prototipo navegación', description: 'Crear prototipo Figma de la nueva navegación con bottom tabs', assigneeId: 'user-3', status: 'done', priority: 'high', estimatedHours: 8, dueDate: ds(-8), completedAt: ds(-9), dependsOn: [], sortOrder: 1, metadata: {}, createdAt: ds(-10), updatedAt: ds(-9) },
    { id: 'task-13b', activityId: 'act-13', planId: 'plan-4', title: 'Implementar bottom tab navigator', description: 'Implementar navegación con tabs inferiores en React Native', assigneeId: 'user-3', status: 'in_progress', priority: 'high', estimatedHours: 16, dueDate: ds(-2), completedAt: null, dependsOn: ['task-13a'], sortOrder: 2, metadata: {}, createdAt: ds(-8), updatedAt: ds(-2) },
    { id: 'task-13c', activityId: 'act-13', planId: 'plan-4', title: 'Agregar gestos de navegación', description: 'Implementar gestos swipe entre tabs', assigneeId: 'user-3', status: 'todo', priority: 'medium', estimatedHours: 8, dueDate: ds(3), completedAt: null, dependsOn: ['task-13b'], sortOrder: 3, metadata: {}, createdAt: ds(-5), updatedAt: ds(-2) },

    // ── Tasks for deep-level activities (nivel 3) ──
    { id: 'task-26a', activityId: 'act-26', planId: 'plan-1', title: 'Migrar controlador de login', description: 'Migrar LoginController a ASP.NET Core 8 con autenticación JWT', assigneeId: 'user-1', status: 'done', priority: 'high', estimatedHours: 6, dueDate: ds(-10), completedAt: ds(-11), dependsOn: [], sortOrder: 1, metadata: {}, createdAt: ds(-25), updatedAt: ds(-11) },
    { id: 'task-26b', activityId: 'act-26', planId: 'plan-1', title: 'Migrar controlador de registro', description: 'Migrar RegisterController con validación de datos', assigneeId: 'user-1', status: 'in_progress', priority: 'medium', estimatedHours: 6, dueDate: ds(-3), completedAt: null, dependsOn: ['task-26a'], sortOrder: 2, metadata: {}, createdAt: ds(-20), updatedAt: ds(-3) },
    { id: 'task-27a', activityId: 'act-27', planId: 'plan-1', title: 'Migrar controlador de transferencias', description: 'Migrar TransferController asegurando integridad transaccional', assigneeId: 'user-1', status: 'todo', priority: 'critical', estimatedHours: 12, dueDate: ds(5), completedAt: null, dependsOn: ['task-26b'], sortOrder: 1, metadata: {}, createdAt: ds(-5), updatedAt: ds(-5) },
    { id: 'task-29a', activityId: 'act-29', planId: 'plan-4', title: 'Implementar cola FIFO offline', description: 'Implementar cola de operaciones en IndexedDB con soporte de reintentos', assigneeId: 'user-3', status: 'in_progress', priority: 'high', estimatedHours: 6, dueDate: ds(1), completedAt: null, dependsOn: [], sortOrder: 1, metadata: {}, createdAt: ds(-6), updatedAt: ds(-2) },
    { id: 'task-30a', activityId: 'act-30', planId: 'plan-4', title: 'Implementar merge de cambios', description: 'Estrategia de merge para reconciliar datos locales con servidor', assigneeId: 'user-3', status: 'todo', priority: 'high', estimatedHours: 8, dueDate: ds(6), completedAt: null, dependsOn: ['task-29a'], sortOrder: 1, metadata: {}, createdAt: ds(-4), updatedAt: ds(-2) },
    { id: 'task-31a', activityId: 'act-31', planId: 'plan-4', title: 'Implementar transiciones animadas', description: 'Animaciones de entrada/salida entre pantallas con Reanimated', assigneeId: 'user-3', status: 'in_progress', priority: 'medium', estimatedHours: 8, dueDate: ds(-1), completedAt: null, dependsOn: [], sortOrder: 1, metadata: {}, createdAt: ds(-10), updatedAt: ds(-2) },
  ]
  ...
  const executionDependencies: Dependency[] = [
    ...
    // ── Deep-level dependencies (nivel 3) ──
    { id: 'depex-5', sourceType: 'activity', sourceId: 'act-27', targetType: 'activity', targetId: 'act-26', relationType: 'depends_on', description: 'Migración de transacciones requiere controlador de autenticación migrado primero', status: 'active', expectedResolutionDate: ds(3), metadata: {}, createdAt: ds(-15), updatedAt: ds(-5) },
    { id: 'depex-6', sourceType: 'activity', sourceId: 'act-30', targetType: 'activity', targetId: 'act-29', relationType: 'depends_on', description: 'Resolución de conflictos necesita cola FIFO implementada', status: 'active', expectedResolutionDate: ds(3), metadata: {}, createdAt: ds(-4), updatedAt: ds(-2) },
    { id: 'depex-7', sourceType: 'activity', sourceId: 'act-31', targetType: 'activity', targetId: 'act-13', relationType: 'depends_on', description: 'Animaciones requieren navegación principal implementada', status: 'active', expectedResolutionDate: ds(-1), metadata: {}, createdAt: ds(-10), updatedAt: ds(-2) },
    // ── Cross-plan dependencies ──
    { id: 'depex-8', sourceType: 'activity', sourceId: 'act-22', targetType: 'activity', targetId: 'act-19', relationType: 'depends_on', description: 'Parches de seguridad requieren logging actualizado para registrar eventos', status: 'active', expectedResolutionDate: null, metadata: {}, createdAt: ds(-20), updatedAt: ds(-5) },
    { id: 'depex-9', sourceType: 'activity', sourceId: 'act-20', targetType: 'activity', targetId: 'act-1', relationType: 'depends_on', description: 'Pruebas de integración requieren migración core completada', status: 'active', expectedResolutionDate: ds(20), metadata: {}, createdAt: ds(-1), updatedAt: ds(-1) },
    { id: 'depex-10', sourceType: 'plan', sourceId: 'plan-3', targetType: 'plan', targetId: 'plan-2', relationType: 'depends_on', description: 'Migración CRM requiere postura de seguridad fortalecida', status: 'active', expectedResolutionDate: ds(30), metadata: {}, createdAt: ds(-10), updatedAt: ds(-5) },
    { id: 'depex-11', sourceType: 'task', sourceId: 'task-22c', targetType: 'task', targetId: 'task-5b', relationType: 'depends_on', description: 'Parches en producción requieren migración de BD completada', status: 'active', expectedResolutionDate: ds(2), metadata: {}, createdAt: ds(-10), updatedAt: ds(-5) },
  ]
