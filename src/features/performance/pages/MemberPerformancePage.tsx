  ...
  return (
    <div className="max-w-full">
        ...
        <div className="grid grid-cols-3 sm:grid-cols-6 gap-2.5 mb-8">
          <div className="flex items-center gap-2.5 px-3 py-2.5 bg-card rounded-xl border border-boundary shadow-sm">
            ...
            <div className="min-w-0">
              <p className="text-base font-bold text-neutral-90 dark:text-white tabular-nums leading-tight">
                {kpis.totalSP}
              </p>
              <p className="text-[10px] text-neutral-50 uppercase tracking-wider leading-tight">
                SP
              </p>
            </div>
          </div>
      ...
      <div>
        ...
        {activeTab === 'skills' && <SkillsSection memberId={member.id} />}
        {activeTab === 'tecnologias' && <TechStackSection memberId={member.id} />}
        {activeTab === 'microservicios' && <MicroservicesSection memberId={member.id} />}
        {activeTab === 'sprints' && <SprintsSection memberId={member.id} teamId={teamId!} />}
        {activeTab === 'oneonone' && <OneOnOneSection memberId={member.id} />}
        {activeTab === 'logros' && <AchievementsSection memberId={member.id} />}
        {activeTab === 'equipamiento' && <EquipmentSection memberId={member.id} />}
      </div>
    </div>
  )
}
