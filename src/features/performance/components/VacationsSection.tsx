      ...
      <div className="bg-white dark:bg-neutral-80 rounded-xl border border-neutral-20 dark:border-neutral-70 p-4 shadow-sm">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-lg font-bold text-neutral-90 dark:text-white">{totalUsed} / {vacationDaysPerYear} días</p>
      ...
      <div className="bg-white dark:bg-neutral-80 rounded-xl border border-neutral-20 dark:border-neutral-70 shadow-sm">
        ...
        <div className="divide-y divide-neutral-20 dark:divide-neutral-70">
          {records.toReversed().map((record) => (
            <div key={record.id} className="px-4 py-3 hover:bg-neutral-10 dark:hover:bg-neutral-70 transition-colors group">
              {editingId === record.id ? (
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4 min-w-0">
                    <div className="shrink-0 text-center">
                      <p className="text-sm font-bold text-neutral-90 dark:text-white">{record.days}</p>
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-xs text-neutral-50 truncate">{record.reason || 'Sin motivo'}</p>
                    </div>
                  </div>
