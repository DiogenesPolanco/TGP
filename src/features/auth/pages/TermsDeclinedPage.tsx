    ...
    <div className="min-h-screen bg-canvas flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-lg relative">
        <div className="bg-white/95 dark:bg-neutral-80/95 backdrop-blur-xl rounded-3xl border border-neutral-20/80 dark:border-neutral-70/80 shadow-2xl shadow-neutral-30/30 dark:shadow-black/30 overflow-hidden p-10 text-center space-y-6">
          ...
          <div className="bg-neutral-5 dark:bg-neutral-85 rounded-xl p-5 border border-boundary text-sm text-muted leading-relaxed">
            <p className="mb-2">Si cambias de opinión más adelante, estaremos aquí.</p>
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <Button
              ...
              variant="primary"
              className="rounded-xl shadow-lg shadow-primary/25 bg-primary text-white hover:bg-primary/90"
            >
              <RefreshCw size={18} />
              Reintentar
            </Button>
