          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              <div className="relative w-[180px] h-[180px] mx-auto lg:mx-0 mb-8">
                ...
                >
                  ...
                  <circle
                    ...
                    strokeWidth="10"
                    strokeLinecap="round"
                    strokeDasharray={`${0.72 * Math.PI * 100} ${0.28 * Math.PI * 100}`}
                    strokeDashoffset={-0.05 * Math.PI * 100}
                  />
                </svg>
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center pointer-events-none">
                  <div
                    className="font-mono text-[48px] leading-none mb-1"
                    style={{ color: '#ffb900' }}
                  >
                    📊
                  </div>
            ...
            <div className="text-center lg:text-left">
              ...
              <div
                ...
                style={{ border: '1px solid rgba(255,185,0,0.1)', borderRadius: 4 }}
              >
                <div
                  className="flex justify-between px-4 py-2.5"
                  style={{ borderBottom: '1px solid rgba(255,185,0,0.06)', color: '#6b7a99' }}
                >
                  <span>Indicador</span>
                  <span>Estado</span>
                </div>
                <div
                  className="flex justify-between px-4 py-2.5"
                  style={{ borderBottom: '1px solid rgba(255,185,0,0.06)' }}
                >
              ...
              <div
                ...
                style={{ color: 'rgba(107,122,153,0.3)' }}
              >
