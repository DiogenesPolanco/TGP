  ...
  return (
    <div className="space-y-5">
      ...
      <div className="bg-neutral-5 dark:bg-neutral-85 rounded-xl p-4 space-y-3">
        <p className="text-xs font-semibold text-neutral-50 uppercase tracking-wider">
        ...
        <div className="space-y-2 text-sm text-secondary">
          <div className="flex items-center gap-3">
            ...
            <span>
              <strong>Unidades de Negocio</strong> — Organización base
            </span>
          </div>
          <div className="flex items-center gap-3 ml-4">
            <span className="text-primary font-bold text-base">2</span>
            <span>
              <strong>Aplicaciones + Microservicios</strong> — El portafolio
            </span>
          </div>
          <div className="flex items-center gap-3 ml-8">
            <span className="text-primary font-bold text-base">3</span>
            <span>
              <strong>Seguridad + Gobierno</strong> — Vulnerabilidades, riesgos, auditoría
            </span>
          </div>
          <div className="flex items-center gap-3 ml-12">
            <span className="text-primary font-bold text-base">4</span>
            <span>
              <strong>Herencia Microservicio→App</strong> — Entidades M:N que se heredan al padre
            </span>
          </div>
          <div className="flex items-center gap-3 ml-16">
            <span className="text-primary font-bold text-base">5</span>
            <span>
              <strong>Equipos + Ejecución</strong> — Personas, planes, daily, OKRs
            </span>
          </div>
          <div className="flex items-center gap-3 ml-20">
            <span className="text-primary font-bold text-base">6</span>
            <span>
              <strong>Dashboard</strong> — THI, KPIs, alertas en tiempo real
            </span>
          </div>
        </div>
      </div>
      ...
      <Button
        onClick={onNext}
        variant="primary"
        className="w-full flex items-center justify-center gap-2 px-5 py-2.5 bg-primary text-white rounded-xl font-medium text-sm hover:bg-primary-dark transition-colors"
      >
...
function StepBusinessUnit({ onNext, onSkip }: StepProps) {
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="text-center space-y-2">
        <h2 className="text-xl font-bold text-neutral-90 dark:text-white">
      ...
      <div className="bg-blue-50 dark:bg-blue-500/10 rounded-xl p-3 border border-blue-200 dark:border-blue-500/20">
        ...
        <div className="flex flex-col gap-1 text-xs text-blue-600/80 dark:text-blue-300/80 font-mono">
          <div className="flex items-center gap-1.5 flex-wrap">
            <span className="px-1.5 py-0.5 rounded bg-blue-100 dark:bg-blue-500/20 font-bold text-[11px]">
              BU
            </span>
            <span className="text-[11px]">→</span>
            <span className="px-1.5 py-0.5 rounded bg-blue-100 dark:bg-blue-500/20 text-[11px]">
              Aplicaciones
            </span>
            <span className="text-[11px]">→</span>
            <span className="px-1.5 py-0.5 rounded bg-blue-100 dark:bg-blue-500/20 text-[11px]">
              Vulnerabilidades · Riesgos · Equipos
            </span>
          </div>
        </div>
      ...
      <div className="flex items-center justify-center gap-3">
        ...
        {onSkip && (
          <Button onClick={onSkip} variant="ghost" size="md" className="px-5">
            Ya tengo BUs
          </Button>
        )}
      </div>
    ...
    <div className="space-y-5">
      ...
      <div className="bg-neutral-5 dark:bg-neutral-85 rounded-xl p-4 space-y-2 text-sm text-secondary">
        ...
        <ul className="space-y-1 list-disc list-inside text-xs">
          <li>
            Nombre, descripción y <strong>BU propietaria</strong> (requiere BU creada previamente)
          </li>
          ...
          <li>
            Vulnerabilidades, incidentes, riesgos y hallazgos se heredan de los microservicios
          </li>
        </ul>
      </div>
      <div className="bg-amber-50 dark:bg-amber-500/10 rounded-xl p-3 border border-amber-200 dark:border-amber-500/20">
        <p className="text-xs text-amber-700 dark:text-amber-300">
          ⚠️ Si no creaste una BU en el paso anterior, la lista de unidades estará vacía y no podrás
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="text-center space-y-2">
        ...
        <p className="text-sm text-muted leading-relaxed">
          Registra las <strong>tecnologías</strong> de tu portafolio: lenguajes, frameworks, bases
          de datos, OS, runtimes. El sistema sincroniza automáticamente fechas EOL desde
          endoflife.date para alertar sobre obsolescencia.
        </p>
      </div>
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="text-center space-y-2">
        ...
        <p className="text-sm text-muted leading-relaxed">
          Crea <strong>equipos</strong> con miembros, roles y asignación porcentual. El sistema
          calcula métricas DORA automáticamente para clasificar el rendimiento (Elite, Alto, Medio,
          Bajo).
        </p>
      </div>
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="text-center space-y-2">
        ...
        <p className="text-sm text-muted leading-relaxed">
          Gestiona <strong>vulnerabilidades</strong> (CVSS, SLA tracking),{' '}
          <strong>incidentes</strong> de seguridad (P1-P4 con RCA), <strong>riesgos</strong> (matriz
          probabilidad×impacto) y<strong> auditoría</strong> (hallazgos con plan de acción).
        </p>
        <div className="bg-amber-50 dark:bg-amber-500/10 rounded-xl p-3 border border-amber-200 dark:border-amber-500/20">
          <p className="text-xs text-amber-700 dark:text-amber-300 leading-relaxed">
            💡 Las entidades se pueden asociar tanto a la aplicación directamente como a cada{' '}
            <strong>microservicio</strong>
      ...
      <div className="grid grid-cols-2 gap-3">
        <Button
          ...
          className="text-left bg-neutral-5 dark:bg-neutral-85 rounded-lg p-3 hover:bg-neutral-10 dark:hover:bg-neutral-75 transition-colors"
        >
...
function StepExecution({ onNext, onSkip }: StepProps) {
  return (
    <div className="space-y-5">
      ...
      <div className="text-center space-y-2">
        <h2 className="text-xl font-bold text-neutral-90 dark:text-white">
          6. Ejecución y Estrategia
        </h2>
        <p className="text-sm text-muted leading-relaxed">
          El módulo de <strong>Ejecución</strong> integra Planes, Daily, Compromisos, Actividades y
          Bloqueos. Los <strong>OKRs</strong> permiten definir objetivos con Key Results medibles y
          vinculados a equipos.
        </p>
      </div>
      <div className="bg-neutral-5 dark:bg-neutral-85 rounded-xl p-4 space-y-2 text-sm">
        <div className="flex items-center gap-3">
          ...
          <span className="text-secondary">
            <strong>Planes</strong> con health status y fechas
          </span>
        </div>
        <div className="flex items-center gap-3">
          <span className="w-2 h-2 rounded-full bg-purple-500" />
          <span className="text-secondary">
            <strong>Daily</strong> con actividades y bloqueos del día
          </span>
        </div>
        <div className="flex items-center gap-3">
          <span className="w-2 h-2 rounded-full bg-purple-500" />
          <span className="text-secondary">
            <strong>OKRs</strong> con Key Results y progreso
          </span>
        </div>
      </div>
      <div className="flex items-center justify-center gap-3">
      ...
      <div className="bg-blue-50 dark:bg-blue-500/10 rounded-xl p-4 border border-blue-200 dark:border-blue-500/20 space-y-2 text-sm">
        <div className="flex items-center gap-3">
          ...
          <span className="text-blue-700 dark:text-blue-300">
            Activa notificaciones para recibir alertas de vencimientos
          </span>
        </div>
      </div>
      <div className="flex items-center justify-center gap-3">
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="text-center space-y-2">
        ...
        <p className="text-sm text-muted leading-relaxed">
          Antes de cargar los datos demo, ingresa tu nombre y correo para personalizar tu usuario
          administrador.
        </p>
      </div>
      ...
      <div className="bg-neutral-5 dark:bg-neutral-85 rounded-xl p-3 space-y-1">
        <p className="text-xs text-muted">
          Se cargarán automáticamente: <strong>10 apps</strong>, microservicios con
          vulnerabilidades, incidentes, riesgos y hallazgos, 180+ tecnologías, equipos, OKRs y más.
        </p>
      </div>
      <div className="flex items-center justify-center gap-3">
        <Button
  ...
  return (
    <div className="text-center space-y-5">
      ...
      <Button
        ...
        variant="primary"
        className="w-full inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-primary text-white rounded-xl font-medium text-sm hover:bg-primary-dark transition-colors"
      >
        ...
        <div className="w-full max-w-lg bg-card rounded-3xl border border-boundary shadow-2xl relative">
          {step > 0 && (
            <Button
              onClick={handleBack}
              variant="ghost"
              className="absolute top-5 left-5 p-2 rounded-xl hover:bg-neutral-10 dark:hover:bg-neutral-75 transition-colors z-10"
              title="Atrás"
            >
