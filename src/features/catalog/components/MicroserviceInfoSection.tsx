  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <fieldset>
          <legend className="block text-xs font-medium text-neutral-50 mb-1">Repositorio</legend>
        ...
        <fieldset>
          <legend className="block text-xs font-medium text-neutral-50 mb-1">Tech Lead</legend>
          <MemberSelector
            value={technicalLead}
            onChange={(v) => {
              setTechnicalLead(v)
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <fieldset>
          <legend className="block text-xs font-medium text-neutral-50 mb-1">Ciclo de Vida</legend>
          <Select
            value={lifecycleStatus}
            onChange={(v) => {
              setLifecycleStatus(v as MicroserviceLifecycleStatus)
              markDirty()
            }}
            options={[
        ...
        {lifecycleStatus === 'decommissioned' && (
          <fieldset>
            ...
            <textarea
              ...
              onChange={(e) => {
                setDecommissionPlan(e.target.value)
                markDirty()
              }}
