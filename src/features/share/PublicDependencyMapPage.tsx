    ...
    <div id="printable-content" className="min-h-screen bg-neutral-10 dark:bg-neutral-90">
      ...
      <main className="px-6 py-8 max-w-screen-2xl mx-auto space-y-6">
        <div className="grid grid-cols-3 gap-4">
          <div className="bg-white dark:bg-neutral-80 rounded-2xl border border-neutral-20 dark:border-neutral-70 p-3 flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center gap-2 text-xs">
                      ...
                      <span className="text-neutral-70 dark:text-neutral-30">Alta</span>
                    </div>
                    <div className="flex items-center gap-2 text-xs">
                      <span className="w-3 h-3 rounded-full bg-[#FF8B00]" />
                      <span className="text-neutral-70 dark:text-neutral-30">Media</span>
                    </div>
                    <div className="flex items-center gap-2 text-xs">
                      <span className="w-3 h-3 rounded-full bg-[#36B37E]" />
                      <span className="text-neutral-70 dark:text-neutral-30">Baja</span>
                    </div>
                  </div>
                </div>
              </div>
