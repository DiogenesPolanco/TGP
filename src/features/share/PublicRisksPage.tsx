...
export function PublicRisksPage() {
  ...
  const columns: Column<any>[] = [
    ...
    { key: 'probability', label: 'Probabilidad', sortable: true, className: 'text-right', render: (v) => <span className="text-neutral-60 dark:text-neutral-40">{v.probability}/5</span> },
    { key: 'impact', label: 'Impacto', sortable: true, className: 'text-right', render: (v) => <span className="text-neutral-60 dark:text-neutral-40">{v.impact}/5</span> },
    {
      key: 'score',
      label: 'Score',
      sortable: true,
    ...
    },
    {
      ...
      label: 'Aplicación',
      sortable: true,
      render: (v: any) => <span className="text-neutral-70 dark:text-neutral-30">{appMap.get(v.applicationId ?? '') ?? '—'}</span>,
    },
  ]
